...
#===============================================================================
#
# GxE interaction for vitamin D using replicated score
#
#===============================================================================
...
for (quartile in c("Q1", "Q2", "Q3", "Q4")) {
  ...
  beta_g <- coef(model)["g"]
  se_g <- summary(model)$coefficients["g", "Std. Error"]
...
save(
  ...
  vitd.fi,
  vitd.month,
  file = "rdata_vitd_interaction_results_20250405_grsSD.RData"
)
