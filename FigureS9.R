...
#===============================================================================
#
# Figure S9: results from VitD empirical negative controls using Focused score
#
#===============================================================================
...
# Load data
#========================================
load("rdata_nlmr_vitd_EmpNegPosControls_results_focusedScore_20251205.RData")
...
ggsave(
  plot = comb,
  filename = "manuscript/figureS9.svg",
  device = "svg",
  scale = 0.9,
  width = 16,
  height = 8,
