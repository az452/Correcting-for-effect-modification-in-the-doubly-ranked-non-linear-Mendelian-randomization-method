...
- `sim_methods.R`: shared simulation utilities used across the scenario scripts.
- `sim_nulloutcome.R`: helper for generating simulated negative-control outcomes used in the falsification tests.
- `create_nlmr_summary2025.R`: function to run uncorrected and corrected doubly-ranked method.
- `custom_summary.R`: custom summary helper.
