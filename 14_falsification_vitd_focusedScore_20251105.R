...
#===============================================================================
#
# Falsification test for vitamin D using focused score
#
#===============================================================================
...
df0 <- vitd.crp[, c(
  "vitd21es_grs", "vitd", "towndepriv", "age",
...
save(
  vitd_simNeg,
  file = "rdata_nlmr_vitd_negControl_results_20251105_focusedScore.RData"
)
